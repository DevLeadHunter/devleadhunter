<template>
  <div class="bg-[#050505] rounded-xl border border-[#30363d]/30 overflow-hidden shadow-2xl">
    ...
    <div class="flex h-[500px]">
      <!-- Sidebar -->
      <div class="w-64 bg-[#1a1a1a] border-r border-[#30363d]/30 p-6">
        ...
        <nav class="space-y-2">
          <div class="px-4 py-2.5 rounded-lg bg-[#21262d]/50 text-[#f9f9f9] text-sm font-medium">
            <i class="fa-solid fa-magnifying-glass w-4 h-4 mr-3"></i>
            Recherche Prospects
          </div>
          <div class="px-4 py-2.5 rounded-lg text-[#8b949e] text-sm hover:bg-[#21262d]/30 transition-colors">
      ...
      <div class="flex-1 bg-[#050505] p-8 overflow-y-auto">
        <h1 class="text-3xl font-bold text-[#f9f9f9] mb-3">Recherche de Prospects</h1>
        <p class="text-sm text-[#8b949e] mb-8 font-light">Lancez une recherche pour trouver de nouveaux prospects</p>
        
        <div class="bg-transparent rounded-xl border border-[#30363d]/30 p-8 space-y-6">
          <div class="grid grid-cols-2 gap-6">
            <div>
              <label class="block text-sm text-[#8b949e] mb-2 font-medium">Catégorie</label>
              <div class="h-10 bg-[#050505] border border-[#30363d]/50 rounded-lg px-4 flex items-center text-sm text-[#8b949e]">
                restaurant
              </div>
            </div>
            <div>
              <label class="block text-sm text-[#8b949e] mb-2 font-medium">Ville</label>
              <div class="h-10 bg-[#050505] border border-[#30363d]/50 rounded-lg px-4 flex items-center text-sm text-[#8b949e]">
                Paris
              </div>
            </div>
          ...
          <div class="flex gap-4">
            ...
            <div class="h-10 bg-transparent border border-[#30363d]/50 text-[#f9f9f9] rounded-lg px-6 flex items-center text-sm">
              Voir mes prospects
            </div>
          </div>
        </div>
