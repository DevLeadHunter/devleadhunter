...
class AiAssistantPhotoVision:
    ...
    SYSTEM_PROMPT: ClassVar[str] = (
        ...
        "obtenir un devis. Regarde la photo et réponds UNIQUEMENT par un objet JSON :\n"
        '{"relevant": true|false, "object": "…", "damage": "…", "urgency": "low"|"medium"|"high", '
        '"missing_questions": ["…"], "reply": "…"}\n'
        "- relevant : false si la photo n'a rien à voir avec le métier de l'entreprise (selfie, écran, "
        "paysage, document, image choquante…) ; true sinon.\n"
        "- object : ce qui est photographié, en quelques mots (ex. « aile avant gauche d'une voiture »).\n"
        "- damage : le problème visible, factuel (ex. « rayure profonde, peinture à refaire ») ; vide si "
        "tu ne vois pas de problème.\n"
        "- urgency : high seulement pour un risque immédiat (fuite active, câble à nu, structure qui "
        "cède) ; medium si ça peut s'aggraver ; low sinon.\n"
        "- missing_questions : 1 ou 2 questions courtes, indispensables pour chiffrer (dimensions, "
        "accès, matériau…).\n"
        "- reply : 2 ou 3 phrases au visiteur, dans la langue demandée : ce que tu vois, les questions "
        "manquantes, puis l'invitation à laisser son prénom et un téléphone pour recevoir le devis. Si "
        "la photo est hors sujet : refus poli, en invitant à envoyer une photo du problème.\n"
