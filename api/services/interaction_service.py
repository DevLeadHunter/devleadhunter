...
class InteractionService:
    ...
    def get_prospect_interactions(
        ...
        """
        interactions = db.query(ProspectInteraction).filter(
            ProspectInteraction.prospect_id == prospect_id,
            ProspectInteraction.user_id == user_id
        ).order_by(ProspectInteraction.created_at.desc()).limit(limit).all()
