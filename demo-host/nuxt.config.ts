...
export default defineNuxtConfig({
  ...
  extends: [
    ...
    'github:DevLeadHunter/devleadhunter-template-barber#v1.2.8',
    'github:DevLeadHunter/devleadhunter-template-landscaper-verdure#v1.6.0',
  ],
    ...
    '/**': {
      ...
      headers: {
        ...
        'Content-Security-Policy':
          ...
          'https://devleadhunter.fr https://devleadhunter.dibodev.fr http://localhost:3000 http://localhost:5173 http://localhost:1420 ' +
