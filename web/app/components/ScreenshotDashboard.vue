<template>
  <div class="overflow-hidden rounded-xl border border-[#30363d]/30 bg-[#050505] shadow-2xl">
    <!-- Browser Chrome -->
    <div class="flex items-center gap-2 border-b border-[#30363d]/30 bg-[#1a1a1a] px-4 py-3">
      <div class="flex gap-1.5">
        <div class="h-3 w-3 rounded-full bg-[#DC4747]"></div>
        <div class="h-3 w-3 rounded-full bg-[#f9f9f9]/20"></div>
        <div class="h-3 w-3 rounded-full bg-[#2BAD5F]"></div>
      </div>
      <div class="flex-1 rounded-lg bg-[#050505] px-4 py-1.5 text-center text-xs font-light text-[#8b949e]">
        devleadhunter.dibodev.fr/dashboard
      </div>
    </div>
    ...
    <div class="flex h-[500px]">
      <!-- Sidebar -->
      <div class="w-64 border-r border-[#30363d]/30 bg-[#1a1a1a] p-6">
        <div class="mb-8 flex items-center gap-2.5">
          ...
          <span class="text-sm font-semibold text-[#f9f9f9]">devleadhunter</span>
        </div>
        <nav class="space-y-2">
          <div class="rounded-lg bg-[#21262d]/50 px-4 py-2.5 text-sm font-medium text-[#f9f9f9]">
            <i class="fa-solid fa-magnifying-glass mr-3 h-4 w-4"></i>
            Recherche Prospects
          </div>
          <div class="rounded-lg px-4 py-2.5 text-sm text-[#8b949e] transition-colors hover:bg-[#21262d]/30">
      ...
      <!-- Main Content -->
      <div class="flex-1 overflow-y-auto bg-[#050505] p-8">
        <h1 class="mb-3 text-3xl font-bold text-[#f9f9f9]">Recherche de Prospects</h1>
        <p class="mb-8 text-sm font-light text-[#8b949e]">Lancez une recherche pour trouver de nouveaux prospects</p>

        <div class="space-y-6 rounded-xl border border-[#30363d]/30 bg-transparent p-8">
          <div class="grid grid-cols-2 gap-6">
            <div>
              <label class="mb-2 block text-sm font-medium text-[#8b949e]">Catégorie</label>
              <div
                class="flex h-10 items-center rounded-lg border border-[#30363d]/50 bg-[#050505] px-4 text-sm text-[#8b949e]"
              >
                restaurant
              </div>
            </div>
            <div>
              <label class="mb-2 block text-sm font-medium text-[#8b949e]">Ville</label>
              <div
                class="flex h-10 items-center rounded-lg border border-[#30363d]/50 bg-[#050505] px-4 text-sm text-[#8b949e]"
              >
                Paris
          ...
          <div class="flex gap-4">
            <div class="flex h-10 items-center rounded-lg bg-[#f9f9f9] px-6 text-sm font-medium text-[#050505]">
              Lancer la recherche
            </div>
            <div
              class="flex h-10 items-center rounded-lg border border-[#30363d]/50 bg-transparent px-6 text-sm text-[#f9f9f9]"
            >
              Voir mes prospects
            </div>
          </div>
...
/**
 * Screenshot component for Dashboard view
 */
</script>
