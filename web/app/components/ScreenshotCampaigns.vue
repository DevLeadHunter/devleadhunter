<template>
  <div class="overflow-hidden rounded-xl border border-[#30363d]/30 bg-[#050505] shadow-2xl">
    ...
    <div class="flex h-[500px]">
      <!-- Sidebar -->
      <div class="w-64 border-r border-[#30363d] bg-[#1a1a1a] p-4">
        ...
        <div class="space-y-4">
          ...
          >
            <div class="flex items-start justify-between">
              <div class="flex-1">
                <h3 class="mb-2 text-lg font-semibold text-[#f9f9f9]">Restaurants Paris</h3>
                <p class="mb-4 text-sm font-light text-[#8b949e]">Campagne pour les restaurants parisiens</p>
                <div class="flex gap-6 text-sm">
                  <span class="font-light text-[#8b949e]">
                    <i class="fa-solid fa-users mr-2 inline"></i>
                    25 prospects
                  </span>
                  <span
                    class="inline-flex items-center rounded-lg bg-[#2BAD5F]/10 px-3 py-1 text-sm font-medium text-[#3fb950]"
                  >
                    active
                  </span>
                </div>
              ...
              <div
                class="ml-6 flex h-10 items-center rounded-lg border border-[#30363d]/50 bg-transparent px-6 text-sm text-[#f9f9f9]"
              >
                Send Emails
              </div>
            </div>
          ...
          >
            <div class="flex items-start justify-between">
              <div class="flex-1">
                <h3 class="mb-2 text-lg font-semibold text-[#f9f9f9]">Salons de coiffure Lyon</h3>
                <p class="mb-4 text-sm font-light text-[#8b949e]">Prospection pour salons de coiffure à Lyon</p>
                <div class="flex gap-6 text-sm">
                  <span class="font-light text-[#8b949e]">
                    <i class="fa-solid fa-users mr-2 inline"></i>
                    18 prospects
                  ...
                  <span
                    class="inline-flex items-center rounded-lg bg-[#71A3DB]/10 px-3 py-1 text-sm font-medium text-[#58a6ff]"
                  >
                    completed
                  </span>
                </div>
